...
### ابزاری که بر بستر آن از مدل استفاده شده است
<ul dir="rtl">
  <li>chrome</li>
</ul>
...
### طریقه تامین مدل
<ul dir="rtl">
  <li>مدل رایگان - استفاده از چندین ایمیل متفاوت</li>
  <li>خرید اکانت پرو</li>
</ul>

### پرامپت‌های ارسال‌شده
...
<div dir="rtl" align="right">
- صفحه categories:
 - برای اون ابتدا باید یک سری تغییرات بدیم. 
  -اول اینکه صفحه movie detail یه بخش کوچیک وسط یه صفحه بزرگه. سعی کن یکم خلاقیت بدی و خوشگلش کنی. نوشته ای چیزی هم به نظرت اومد بهترش میکنه، اضافه کن.
  -دوم اینکه تو همین صفحه یه باید یه بخشی اضافه کنی که کاربر بتونه فیلمش رو بزاره تو دسته ای که میخواد. 
 - یوزر استوری های مربوط بهش ایناس.
  -به عنوان یک کاربر، می‌خواهم فیلم‌ها را در دسته‌بندی‌های شخصی خود ذخیره یا حذف کنم تا فیلم‌های مورد علاقه‌ام را سازماندهی کنم.
  -به عنوان یک کاربر، می‌خواهم دسته‌بندی‌های جدید ایجاد کنم تا فیلم‌ها را بر اساس سلیقه شخصی دسته‌بندی کنم
  -به عنوان یک کاربر، می‌خواهم دسته‌بندی‌های خود را ویرایش یا حذف کنم تا مدیریت بهتری روی لیست‌هایم داشته باشم.
  -به عنوان یک کاربر، می‌خواهم فیلم‌ها در هر دسته‌بندی بر اساس امتیاز نمایش داده شوند تا فیلم‌های برتر هر دسته را سریع ببینم. تو صفحه category هم باید دسته‌بندی های فرد باشه و به صورت default صفحه favorites رو نشون بده. تو قسمت sidebar صفحه accout باید زیر category به صورت زیربخش اسامی دسته‌بندی ها باشه تا کاربر بتونه انتخاب کنه و صفحه دسته بندی های مورد نظرش بیاد.
